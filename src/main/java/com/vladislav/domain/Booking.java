...
public class Booking {
    ...
    private Booking(Integer id, Long timeOfReg, Event event, Long timeOfStart,
        ...
        this.timeOfRegString = new SimpleStringProperty(primaryDateFormat.format(new Date(timeOfReg)));
        this.event = new SimpleObjectProperty<>(event);
        this.timeOfStart = timeOfStart;
        this.timeOfStartString = new SimpleStringProperty(primaryDateFormat.format(new Date(timeOfStart)));
        this.timeOfEnd = timeOfEnd;
        this.timeOfEndString = new SimpleStringProperty(primaryDateFormat.format(new Date(timeOfEnd)));
